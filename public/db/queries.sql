...
CREATE TABLE Customer(customerId INT AUTO_INCREMENT PRIMARY KEY,nic VARCHAR(20) NOT NULL,licenseNumber VARCHAR(30) NOT NULL,FName VARCHAR(100),MName VARCHAR(100),LName VARCHAR(100),email VARCHAR(100),address VARCHAR(300),telephone INT, userId INT, FOREIGN KEY(userId) REFERENCES User(userId),isDeleted BOOLEAN DEFAULT 0);
